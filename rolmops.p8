...
level_defs={{
  name="going down",
  packed="map_def={24,16,8,8,0,60},objects={{9,2},{4,3},{9,4},{2,9},{9,6},{4,7},{9,8},{4,9},{2,2},{2,4},{4,5},{2,5},{2,7}},movers={{3,3}}"
 },{
  name="ride the waves",
  ...
  name="tea party",
  packed="map_def={24,8,8,8,1,-240},objects={{9,2},{9,3,6,10},{9,4,6,10},{8,4,6,10},{8,6,7,58,15},{9,6,7,59,15},{8,2,7,58,16},{8,3,7,59,16}},movers={{2,9},{2,2},{3,2},{2,8,1},{3,8,1},{4,8,1},{5,8,1},{6,8,1},{7,8,1},{8,8,1}}"
 },{
  name="besieged",
  packed="map_def={24,0,8,8,1,-180},objects={{2,9},{7,9},{3,9,6,13},{4,9,6,13},{5,9,6,13},{6,9,6,13}},movers={{4,3},{8,7},{9,7},{8,8},{9,8},{8,9},{9,9},{2,5,1},{3,5,1},{4,5,1},{5,5,1},{6,5,1},{7,5,1},{7,4,1},{7,3,1},{7,2,1}}"
 },{
  name="down the river",
  ...
  name="boxing day",
  packed="map_def={8,16,6,6,1,-120},objects={{3,2,6},{4,2,6},{7,4,6},{5,7,6},{3,7,6}},movers={{7,2},{2,2,2},{3,4,2},{4,5,2},{6,4,2},{7,7,2},{3,5,1},{3,6,1},{5,3,1},{4,7,1},{6,7,1}}"
 },{
  name="ic trouble",
  ...
  name="seasick",
  packed="map_def={24,24,8,8,1,180},objects={{2,2},{9,2},{2,9},{9,9},{3,3,1,6,5},{8,3,2,6,6},{8,8,3,5,6},{3,8,4,5,5}},movers={{5,8},{4,2},{7,2},{3,2,2},{2,3,2},{8,2,2},{9,3,2},{2,8,2},{3,9,2},{9,8,2},{8,9,2}}"
 },{
  name="puzzles",
  packed="map_def={0,24,8,8,1,-240},objects={{2,8},{2,7,6,10},{2,9,6,13},{3,9,6,13},{9,5,6,13},{9,6,6,13},{9,7,6,13},{4,9,1,7,9},{5,9,3,9,9}},movers={{2,2},{9,9,1},{4,9,1},{4,7,2},{3,5,1},{2,3,2},{3,3,1},{4,3,1},{5,3,1},{6,3,2},{6,2,2}}"
 },{
  name="warehouse",
  packed="map_def={8,24,8,8,1,-240},objects={{6,2,6},{9,6,6},{4,9,6}},movers={{6,6},{2,2},{3,2},{9,2},{9,3},{8,9},{9,9},{5,5,1},{5,6,1},{5,7,1},{4,5,1},{6,5,1},{2,3,2},{3,3,2},{4,3,2},{5,3,2},{8,2,2},{8,3,2},{8,4,2},{8,5,2},{5,8,2},{6,8,2},{7,8,2},{8,8,2},{9,8,2}}"
 }
}
...
colmaps=unpack("{80,101,118,16},{131,155},{129,156},{141,158},{132},{113},{115},{206,29,210,86,101,224},{86,102,22},{81,109,124},{245,168,138,224,209,29,86,101},{245,224},{100,20},{21},{230},{237,214}")
colmaps[0]={} --default
...

...

...

...

__label__
...

