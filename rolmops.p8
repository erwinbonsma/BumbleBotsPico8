...
level_defs={{
  ...
  name="besieged",
  packed="map_def={24,0,8,8,1,-180,50},objects={{2,9},{7,9},{3,9,6,13},{4,9,6,13},{5,9,6,13},{6,9,6,13}},movers={{4,3},{8,7},{9,7},{8,8},{9,8},{8,9},{9,9},{2,5,1},{3,5,1},{4,5,1},{5,5,1},{6,5,1},{7,5,1},{7,4,1},{7,3,1},{7,2,1}}"
 },{
  name="down the river",
