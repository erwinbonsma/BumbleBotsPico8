...
level_defs={{
  ...
  packed="map_def={8,0,8,8,1,180,0},objects={{2,2},{9,2},{2,9},{4,4},{8,4},{4,8},{8,8}},movers={{6,9},{5,2},{5,3}}"
 },{
  name="barsaman",
  ...
  name="besieged",
  packed="map_def={24,0,8,8,1,-240,50},objects={{2,9},{7,9},{3,9,6,13},{4,9,6,13},{5,9,6,13},{6,9,6,13}},movers={{4,3},{9,6},{8,7},{9,7},{8,8},{9,8},{8,9},{9,9},{2,5,1},{3,5,1},{4,5,1},{5,5,1},{6,5,1},{7,5,1},{7,4,1},{7,3,1},{7,2,1}}"
 },{
  name="down the river",
...
function mainscreen_draw()
 ...
 if clock<60 then
  spr(147,46,26,2,1) --version
  spr(149,0,57,1,1) --(c)
  print("2017-18 eriban",8,58,13)
 else
  print_await_key(
   "start",clock%300>270
  )
...
function new_progress_mgr()
 ...
 --init
 cartdata("eriban_bumblebots_lowrez")
 if (
  dget(0)==vmajor and
  dget(1)>=vminor
 ) then
...
function game_over_anim()
 ...
 function me.draw()
  local showbest=(
   progress_mgr.improved_hi and
   clk%30>15
  )
  if showbest then
   spr(163,17,11,4,2) --best
  end
  spr(218,16,20,4,3) --game over
  if showbest then
   spr(207,18,29,1,2) --o2e
  end
 end
...

...

...
__label__

